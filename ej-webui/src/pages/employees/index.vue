          ...
          <el-table-column label="操作">
            <template v-slot="scope">
              ...
              <el-button
                ...
                >删除</el-button
              >
              <el-button type="text" @click="toDetailHandler(scope.row.id)"
                >详情</el-button
              >
            </template>
          </el-table-column>
